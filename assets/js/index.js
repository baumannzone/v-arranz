...
$(function () {
  ...
  $('.navbar ul.nav li a').on( 'click', function ( e ) {
    ...
    if ( href == '#restaurante' || href == '#galeria' ) {
      // Navbar heigth
      distancia = 70;
    }

    $('html, body').animate({
      scrollTop: $( $.attr(this, 'href') ).offset().top - distancia
    }, 500);
    return false;
  });

  // Btn
  $('#inicio a.ver-mas-btn').on( 'click', function ( e ) {
    e.preventDefault();
    var distancia = 0;
    var href = $.attr(this, 'href');
  ...
  // Init gallery
  $('.section .gallery-cont').magnificPopup({
    delegate: 'a',
    type: 'image',
    gallery: {
      enabled: true
